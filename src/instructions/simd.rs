...
pub enum SIMD {
    ...
    V128Store(MemArg) = 11,
    V128Load8Lane(MemArg, LaneId16) = 84,
    V128Load16Lane(MemArg, LaneId8) = 85,
    V128Load32Lane(MemArg, LaneId4) = 86,
    V128Load64Lane(MemArg, LaneId2) = 87,
    V128Store8Lane(MemArg, LaneId16) = 88,
    V128Store16Lane(MemArg, LaneId8) = 89,
    V128Store32Lane(MemArg, LaneId4) = 90,
    V128Store64Lane(MemArg, LaneId2) = 91,
