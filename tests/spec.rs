...
const IGNORED_MODULES: &[&[u8]] = &[
    // The binary format allows representing 64 bit values in limits even when the 64 bit flag is not
    // set - we parse these as is.
    #[cfg(feature = "threads")]
    &[
        0x00, 0x61, 0x73, 0x6D, 0x01, 0x00, 0x00, 0x00, 0x05, 0x08, 0x01, 0x01, 0x00, 0x80, 0x80,
        0x80, 0x80, 0x10,
    ],
    #[cfg(feature = "threads")]
    &[
        0x00, 0x61, 0x73, 0x6D, 0x01, 0x00, 0x00, 0x00, 0x05, 0x07, 0x01, 0x00, 0x80, 0x80, 0x80,
        0x80, 0x10,
    ],
    #[cfg(feature = "threads")]
    &[
        0x00, 0x61, 0x73, 0x6D, 0x01, 0x00, 0x00, 0x00, 0x05, 0x0C, 0x01, 0x01, 0x80, 0x80, 0x80,
